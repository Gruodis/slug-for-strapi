...
exports.default = ({ strapi }) => ({
    ...
    async generateSlugForEntry(data, contentType, currentEntity = null) {
        ...
        let sourceText = this.extractTextFromField(data[config.sourceField]);
        ...
        if (!sourceText && config.fallbackField) {
            ...
            sourceText = this.extractTextFromField(data[config.fallbackField]);
        ...
        const slug = await this.generateUniqueSlug(sourceText, contentType, excludeId, config.slugifyOptions);
